...
> **Severity:** Medium (Affects purchases)
> **Platform:** Mobile (Android)
> **Steps to Reproduce:** 1. Open the game on mobile. 2. Click the 'Shop' icon. 3. Observe the overlap.
> **Expected Result:** Shop buttons align perfectly.
> **Actual Result:** The 'Buy' button blocks the close menu icon.
